...
@interface CoWorkerViewController ()<UICollectionViewDelegateFlowLayout, UICollectionViewDelegate, UICollectionViewDataSource>

@property (strong, nonatomic) IBOutlet UICollectionView *myCollectionView;
@property (nonatomic) NSMutableArray *coworkerArray;
@end

@implementation CoWorkerViewController

- (void)viewDidLoad
{
    [super viewDidLoad];
    //these are very important items
    self.coworkerArray = [NSMutableArray new];
...
{
    return self.coworkerArray.count;
}
...
-(UICollectionViewCell*)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    User *user = self.coworkerArray [indexPath.row];
...
-(void)load
{
    ...
    {
        if (user.isFriend.boolValue && ![self.coworkerArray containsObject:user])
        {
            [self.coworkerArray addObject:user];
        }
    }
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if ([sender isKindOfClass:[UserCollectionViewCell class]])
    {
        ...
        destination.currentUsersArray = self.coworkerArray;
